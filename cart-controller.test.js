...
describe('cart controller', () => {
    ...
    it('should return a cart by cart id', async () => {
        const response = await fakeServer.inject({
            method: 'GET',
    ...
    it('should be able to delete an existing cart', async () => {
        ...
        expect(removeCustomerByCartId).toHaveBeenCalledTimes(1);
        expect(removeCustomerByCartId).toHaveBeenCalledWith(expectedCartId);
    });
});